...
export async function POST(request: NextRequest) {
  // TODO: get orgId from real auth session (Phase 7 full)
  ...
  await upsertIntegration(orgId, "n8n", {
  ...
  return NextResponse.json({
    success: true,
    provider: "n8n",
    secret, // Return once so client can store it â€” never returned again
    message: "n8n connected. Save the secret â€” it won't be shown again.",
  })
}
